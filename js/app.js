class UI {
  ...
  //Show Balance
  showBalance() {
    // console.log(`Hey I am from ShowBalance and i am getting a hold of 'this' keyword`);
  ...
  totalExpense() {
    ...
    if (this.itemList.length > 0) {
      total = this.itemList.reduce((accumulator, currentAmt) => {
        accumulator += currentAmt.amount      
        return accumulator;
